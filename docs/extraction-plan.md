...
export default createMcpWorker<Env, ZendeskClient>({
	server: { name: 'Zendesk API Server', version: '1.0.0',
	...
	approvalDialog: { name: 'Momentum Zendesk MCP',
